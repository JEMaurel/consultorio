<?php
// Guarda la historia clínica completa en un archivo dentro de bacap/historias
...
// Genera el respaldo de turnos por día en bacap/respaldo_turnos_por_dia.txt
function generar_respaldo_turnos($conn) {
    ...
    file_put_contents($dir . 'respaldo_turnos_por_dia.txt', $txt);
}
